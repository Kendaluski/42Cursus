...
/*   Updated: 2023/05/23 14:52:29 by jjaen-mo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief The size of the buffer used to read the file
 * 
 */
# ifndef BUFFER_SIZE
...
/**
 * @brief The max value of a file descriptor
 * 
 */
# ifndef FD_MAX
#  define FD_MAX 1024
...
/**
 * @brief Get the next line of FD file
 * This one reads multiple FD, that's why STACK is now a 2d array, storing
 * each stack of remaining files in the address of each FD
